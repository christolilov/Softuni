					...
					for (String card4 : allCards) {
						for (String card5 : allCards) {
							if(card1.charAt(0)==card2.charAt(0)&&card2.charAt(0)==card3.charAt(0)
									&&card4.charAt(0)==card5.charAt(0)&&card1.charAt(0)!=card5.charAt(0)){
								if(card1.charAt(1)!=card2.charAt(1)&&card2.charAt(1)!=card3.charAt(1)&&card1.charAt(1)!=card3.charAt(1)&&card4.charAt(1)!=card5.charAt(1)){
